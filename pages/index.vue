  ...
  <div class="home">
    <div class="section1">
      <div class="section1-left">
        <div class="section1-left-text">Stunning Photography by</div>
        <h1 class="section1-heading">Damien Braun</h1>
      </div>
      <svg class="section1-middle" xmlns="http://www.w3.org/2000/svg" width="262" height="256" viewBox="0 0 262 256"
        fill="none">
        <path
      ...
      <div class="section1-right">
        <div class="section1-right-wrapper">
          <h1>Let’s</h1>
          <div class="purple-btn">
            <div class="purple-btn-background"></div>
            <svg class="purple-btn-svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
              fill="none">
...
<script>
import arrowDownImage from '@/assets/image/arrow-down.svg';
import arrowUpperImage from '@/assets/image/arrow-upper.svg';
...
@media screen and (min-width: 992px) {
  ...
  .home .purple-btn-background {
    display: flex;
    padding: 28px 50px;
    align-items: center;
    gap: 10px;
    border-radius: 100px;
    background: var(--Purple-55, #4A2CED);
  ...
  .home .section4 .arrow-left-btn,
  .home .section4 .arrow-right-btn,
  .home .section5 .arrow-left-btn,
  .home .section5 .arrow-right-btn,
  .home .section7 .arrow-left-btn,
  .home .section7 .arrow-right-btn {
    display: flex;
    padding: 10px;
    align-items: center;
    border-radius: 100px;
